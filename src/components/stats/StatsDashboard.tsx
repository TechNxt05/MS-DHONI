...
const stats = [
    ...
    { label: 'T20I Runs', value: '1,617', icon: Disc, color: 'text-india-blue' },
    ...
    return (
        <section id="stats" className="py-24 bg-black text-white">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
                    {stats.map((stat, index) => (
                        <motion.div
                            ...
                            className="p-4 md:p-6 rounded-2xl bg-zinc-900 border border-zinc-800 flex flex-col items-center justify-center text-center hover:bg-zinc-800 hover:border-csk-yellow/40 transition-colors group"
                        >
                ...
                <div className="mt-16 p-6 md:p-8 rounded-3xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 relative overflow-hidden">
