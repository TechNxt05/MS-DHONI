                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-4 md:gap-6 space-y-4 md:space-y-6">
                    {displayImages.map((src, index) => (
                        <motion.div
                            ...
                            className="relative mb-4 md:mb-6 break-inside-avoid overflow-hidden rounded-xl bg-zinc-800 group cursor-pointer border border-zinc-800 hover:border-csk-yellow/40"
